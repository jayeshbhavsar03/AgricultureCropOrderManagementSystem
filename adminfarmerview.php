      ...
      <table class="table table-striped table-bordered">
        ...
        <tr>
         ...
         if($result->num_rows>0)
         {
           ...
           {
             $f_id=$row['farmer_id'];
             echo "<tr><td>".$row["farmer_id"]."</td><td>".$row["farmer_name"]."</td><td>".$row["phone_number"]."</td><td>".$row["email"]."</td><td>".$row["city"]."</td><td><form action='adminfarmerdelete.php' style='display: flex;justify-content: center;' method='post'><input type='submit' name='farmer' value=".$f_id." style='color:red;background:red;width: 29px;height:25px;border-radius: 4px;border-color:red;'></form></td><tr>";
